...
static std::string TOKEN_NAMES[] = {
	...
	"LETTER8", "LETTER16", "LETTER32", "TEXT8", "TEXT16", "TEXT32", "WORD",
	...
	"TRUE", "FALSE", "NULLPTR", "NEW", "DELETE", "IN", "IS", "AS", "TYPEOF",
	...
	"EXCL", "EXCLEQ", "LESS", "BIGGER", "EQEQ", "LESSEQ", "BIGGEREQ", "ANDAND", "OROR", "LPAR", "RPAR", "LBRACE", "RBRACE",
